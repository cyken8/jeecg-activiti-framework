...
public final class claimedTask_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path;
      ...
      out.write("<table id=\"claimedTask\" style=\"width: 700px; height: 300px\">\r\n");
      out.write("\t<thead>\r\n");
      out.write("\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\topt: \"[<a href=\\\"#\\\" onclick=\\\"add('办理','leaveController.do?taskCompletePageSelect&jspPage=\"+data.rows[i].description+\"&processInstanceId=\"+data.rows[i].processInstanceId+\"&taskId=\"+data.rows[i].taskId+\"','claimedTask')\\\">办理</a>]\"\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t    \t$('#claimedTask').datagrid('reload');\r\n");
      out.write("\t    }\r\n");
      out.write("\t    \r\n");
      out.write("\t\t// 设置datagrid属性\r\n");
      out.write("\t\t$('#claimedTask').datagrid({\r\n");
      ...
      out.write("\t        url:'activitiController.do?claimedTaskDataGrid',  \r\n");
      ...
      out.write("\t    }); \r\n");
      out.write("\t    //设置分页控件  \r\n");
      out.write("\t    $('#claimedTask').datagrid('getPager').pagination({  \r\n");
      out.write("\t        pageSize: 10,  \r\n");
