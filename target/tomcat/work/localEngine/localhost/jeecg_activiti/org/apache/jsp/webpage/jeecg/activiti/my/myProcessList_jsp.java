package org.apache.jsp.webpage.jeecg.activiti.my;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class myProcessList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path;
      ...
      out.write("<table id=\"myprocessList\" style=\"width: 700px; height: 300px\">\r\n");
      out.write("\t<thead>\r\n");
      out.write("\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\topt: \"[<a href=\\\"#\\\" onclick=\\\"add('发起新流程','activitiController.do?startPageSelect&startPage=\"+data.rows[i].startPage+\"','myprocessList')\\\">发起新流程</a>]\"\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("    \t\tvar queryParams=$('#myprocessList').datagrid('options').queryParams;\r\n");
      out.write("    \t\tqueryParams[name]=value;\r\n");
      out.write("    \t\tqueryParams.searchfield=name;\r\n");
      out.write("    \t\t$('#myprocessList').datagrid('load');\r\n");
      out.write("    \t}\r\n");
      out.write("\t    // 刷新\r\n");
      out.write("\t    function reloadTable(){\r\n");
      out.write("\t    \t$('#myprocessList').datagrid('reload');\r\n");
      out.write("\t    }\r\n");
      out.write("\t    \r\n");
      out.write("\t\t// 设置datagrid属性\r\n");
      out.write("\t\t$('#myprocessList').datagrid({\r\n");
      out.write("\t\t\ttitle: '发起新流程',\r\n");
      ...
      out.write("\t    }); \r\n");
      out.write("\t    //设置分页控件  \r\n");
      out.write("\t    $('#myprocessList').datagrid('getPager').pagination({  \r\n");
      out.write("\t        pageSize: 10,  \r\n");
