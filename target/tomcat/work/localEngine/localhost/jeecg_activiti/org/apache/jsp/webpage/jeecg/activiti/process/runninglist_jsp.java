...
public final class runninglist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path;
      ...
      out.write("<table id=\"runningList\" style=\"width: 700px; height: 300px\">\r\n");
      out.write("\t<thead>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<th field=\"id\">编号</th>\r\n");
      out.write("\t\t\t<th field=\"processDefinitionId\" width=\"50\">流程定义</th>\r\n");
      out.write("\t\t\t<th field=\"processInstanceId\" width=\"50\">流程实例</th>\r\n");
      out.write("\t\t\t<th field=\"activityId\" width=\"50\">activityId</th>\r\n");
      ...
      out.write("\t\t//查看流程历史\r\n");
      out.write("\t\tfunction viewHistory(processInstanceId){\r\n");
      out.write("\t\t\tvar url = \"\";\r\n");
      out.write("\t\t\tvar title = \"流程历史\";\r\n");
      out.write("\t\t\turl = \"activitiController.do?viewProcessInstanceHistory&processInstanceId=\"+processInstanceId+\"&isIframe\"\r\n");
      ...
      out.write("\t\t\t\t\tactivityId: data.rows[i].activityId,\r\n");
      out.write("\t\t\t\t\topt: \"[<a href=\\\"#\\\" onclick=\\\"viewHistory('\"+data.rows[i].processInstanceId+\"')\\\">历史</a>]\"\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t$('#runningList').datagrid({\r\n");
      out.write("\t\t\ttitle: '运行中流程列表',\r\n");
      ...
      out.write("\t        url:'activitiController.do?runningProcessDataGrid',  \r\n");
      ...
      out.write("\t    }); \r\n");
      out.write("\t    //设置分页控件  \r\n");
      out.write("\t    $('#runningList').datagrid('getPager').pagination({  \r\n");
      out.write("\t        pageSize: 10,  \r\n");
