...
public final class finishedTask_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path;
      ...
      out.write("<table id=\"finishedTask\" style=\"width: 700px; height: 300px\">\r\n");
      out.write("\t<thead>\r\n");
      out.write("\t\t<tr>\r\n");
      ...
      out.write("\t    \t$('#finishedTask').datagrid('reload');\r\n");
      out.write("\t    }\r\n");
      out.write("\t    \r\n");
      out.write("\t\t// 设置datagrid属性\r\n");
      out.write("\t\t$('#finishedTask').datagrid({\r\n");
      out.write("\t\t\ttitle: '待办任务列表',\r\n");
      ...
      out.write("\t        url:'activitiController.do?finishedTaskDataGrid',  \r\n");
      ...
      out.write("\t    }); \r\n");
      out.write("\t    //设置分页控件  \r\n");
      out.write("\t    $('#finishedTask').datagrid('getPager').pagination({  \r\n");
      out.write("\t        pageSize: 10,  \r\n");
